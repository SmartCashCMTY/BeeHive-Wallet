...
## License
SmartCash Core components are released under the MIT License.
The BeeHive Wallet application incorporates various open-source packages
(Electron, React, and npm dependencies) each distributed under their
respective licenses (MIT, Apache 2.0, BSD, ISC, and others).
See the package.json and node_modules directory for individual license files.
See https://github.com/SmartCashCMTY/Core-Source-Repo for SmartCash Core license.
## Disclaimer
